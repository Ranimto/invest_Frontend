...
import bgImage from "assets/images/engineering.png";
            ...
            <div style={{ marginTop: '20px' }}>
                {step > 4 && (
                    <div className="validation">
                        <div className="btn">
                            <Button type='submit' color='primary' variant='contained' style={{ backgroundColor: 'blueviolet', color: 'white' }} onClick={() => { handleDone(formData); }}>Done</Button>
                        </div>
                    </div>
                )}
                {FormSuccess && (
